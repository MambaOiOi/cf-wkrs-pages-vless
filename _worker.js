...
// 生成配置文件的 CF 优选 IP
const bestCFIP = "172.67.22.129"

// 用于 CF 网站的代理 IP
const proxyIPs = ["172.232.235.85"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
